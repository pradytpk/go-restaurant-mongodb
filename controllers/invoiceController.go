...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while fetching the Invoices item"})
		}
...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		err := foodCollection.FindOne(ctx, bson.M{"order_id": invoiceId}).Decode(&invoice)
		if err != nil {
